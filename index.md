...
<div id='gist_data'>
<div id='gist_head'>
<p style="background-color: #EAEAEA;border: 1px solid #DEDEDE;margin: 0px;"><strong>Example: </strong>/api/v1/brand/55/?format=json&username=your_username&api_key=your_apikey</p>
<a style="float: right">Hide</a>
</div>
